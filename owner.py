...
from config import DB_PATH, OWNER_ID, LOG_CHAT_ID  # Assuming LOG_CHAT_ID exists for logging
...
# Call this in the main file if needed, e.g., in if __name__ == "__main__": init_mods_db()
...
def register_owner_handlers(app):
    init_mods_db()  # Initialize mods table
